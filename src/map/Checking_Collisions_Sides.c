...
/*   Updated: 2023/03/15 22:30:00 by anramire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int check_up_collisions(t_map *map, t_player *player, int advance_x, int advance_y)
{
	int aux_advance_y;
	int aux_y;
...
int	check_down_collisions(t_map *map, t_player *player, int advance_x, int advance_y)
{
	int aux_advance_y;
	int aux_y;
...
int	check_left_collisions(t_map *map, t_player *player, int advance_x, int advance_y)
{
	int aux_advance_x;
	int aux_x;
...
int	check_right_collisions(t_map *map, t_player *player, int advance_x, int advance_y)
{
	int aux_x;
	int aux_advance_x;
