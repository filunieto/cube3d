...
/*   Updated: 2023/03/15 22:31:56 by anramire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/map/Map.h"

static void	check_collision(t_map *map, t_player *player, int advance_x, int advance_y);
...
extern int check_up_collisions(t_map *map, t_player *player, int advance_x, int advance_y);
extern int	check_down_collisions(t_map *map, t_player *player, int advance_x, int advance_y);
extern int	check_left_collisions(t_map *map, t_player *player, int advance_x, int advance_y);
extern int	check_right_collisions(t_map *map, t_player *player, int advance_x, int advance_y);

//This functions are defined in Utils_Collisions.c
extern int check_left_up_player(t_player *player, t_map *map, int advance_x, int advance_y);
extern int check_right_up_player(t_player *player, t_map *map, int advance_x, int advance_y);
extern int check_left_down_player(t_player *player, t_map *map, int advance_x, int advance_y);
extern int check_right_down_player(t_player *player, t_map *map, int advance_x, int advance_y);
