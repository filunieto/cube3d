...
# define ERR_COLOR_INP4_MES	"RGB values are equal for colours of \
heaven and ground \n"
...
# define ERR_MAP0_MES	"map with less than 3 lines. there is no \
possibility to place the player\n"
